...
namespace KBAW.Migrations.Models
{
    ...
    {
        public static OperationBuilder<SqlOperation> ExecuteSql(this MigrationBuilder migrationBuilder, string sqlCommand, bool suppressTransaction = false)
        {
        ...
        public static void ExecuteSqlFile(this MigrationBuilder migrationBuilder, int? index = null)
        {
            ...
            var sqlResourceStream = Assembly.GetExecutingAssembly()
                .GetManifestResourceStream($"KBAW.Migrations.{migrationId}{(index != null ? '_' + index.Value : string.Empty)}.sql");
