...
public static class MaterialCombinationIPW
{
    ...
    {
        {
            -1, (int)Materials.AlAlloys, (int)Materials.CuZn, (int)Materials.Bronze, (int)Materials.CarbidesCemented,
            (int)Materials.CoAlloys,
            (int)Materials.Columbium, (int)Materials.Cu, (int)Materials.CuNi, (int)Materials.Pb,
            (int)Materials.MgAlloys, (int)Materials.Mo,
            (int)Materials.NiAlloys, (int)Materials.SteelAlloy, (int)Materials.SteelCarbon,
            (int)Materials.SteelFreeMachG, (int)Materials.SteelMaraging,
            (int)Materials.SteelSintered, (int)Materials.SteelStainless, (int)Materials.SteelTool, (int)Materials.Ta,
            (int)Materials.TiAlloys,
