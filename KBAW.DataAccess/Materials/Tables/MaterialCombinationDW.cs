...
public static class MaterialCombinationDW
{
    ...
    {
        {
            -1, (int)Materials.Al, (int)Materials.AlAlloys, (int)Materials.Bronze, (int)Materials.BronzeAlloys,
            (int)Materials.Cu, (int)Materials.CuAlloys,
            (int)Materials.Co, (int)Materials.CoAlloys, (int)Materials.Fe, (int)Materials.FeAlloys,
            (int)Materials.Mo, (int)Materials.MoAlloys, (int)Materials.Ni, (int)Materials.NiAlloys, (int)Materials.Nb,
            (int)Materials.NbAlloys,
            (int)Materials.Ta, (int)Materials.TaAlloys, (int)Materials.Ti, (int)Materials.TiAlloys,
            (int)Materials.W, (int)Materials.WAlloys, (int)Materials.Zr, (int)Materials.ZrAlloys,
            (int)Materials.Ceramics,
        },
