...
public class McIpwWeldingResultTest
{
    ...
    public void GetWeldingResult_QualityСonnection()
    {
        ...
        Assert.Equal(result,
            MaterialCombinationIPW.GetWeldingResult((int)Materials.TiAlloys, (int)Materials.SteelStainless));
    }
    ...
    public void GetWeldingResult_NotData()
    {
        ...
        Assert.Equal(result,
            MaterialCombinationIPW.GetWeldingResult((int)Materials.Bronze, (int)Materials.CarbidesCemented));
    }
